package com.github.xzb617.encryption.autoconfigure.envirs.impl;
 ...
 * @description:
 */
public class ConfigurableAlgorithmEnvironments implements AlgorithmEnvironments {
    ...
    public ConfigurableAlgorithmEnvironments(ConfigurableEnvironment configurableEnvironment) {
